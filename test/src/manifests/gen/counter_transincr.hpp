#ifndef AUTOFSM_COUNTER_TRANSINCR_HPP
#define AUTOFSM_COUNTER_TRANSINCR_HPP
...
class ICounter_transincrActionHandler;
class CCounter_transincrFSM
{
public:
	struct data_model {
		friend class CCounter_transincrFSM;
		data_model( void ): value() { /* nop */ }
		int value;
	private:
		ICounter_transincrActionHandler* actionHandler;
	} model;
...
public:
	...
	{
	public:
		virtual state* unconditional( CCounter_transincrFSM& ) { return 0; }
		virtual state* unconditional_async( CCounter_transincrFSM& ) { return 0; }
		virtual state* initial( CCounter_transincrFSM& ) { return 0; }
	...
	state *cur_state;
	typedef state* ( state::*event )( CCounter_transincrFSM& );
...
private: 
	...
	public:
		// --------------------------------------------------------------------------
		CPAsyncEventTransitionData( CCounter_transincrFSM& fsm, const event trigger ): mFSM( fsm ), mTrigger( trigger ) { /* none */ }
		// --------------------------------------------------------------------------
	...
	public:
		// --------------------------------------------------------------------------
		CPAsyncTriggerInvoker( CCounter_transincrFSM& fsm ) : mFsm( fsm ) { /* none */ }
		// --------------------------------------------------------------------------
...
public:
	...
	{
	public:
		state* operator()( S *s, D &d, CCounter_transincrFSM &sc )
		{
	...
	{
	public:
		S* operator()( S *s, CCounter_transincrFSM &sc )
		{
...
public:
	...
	// --------------------------------------------------------------------------
	CCounter_transincrFSM( ICounter_transincrActionHandler* pActionHandler ) : cur_state( &m_scxml ), asyncTriggerInvoker( *this )
	// --------------------------------------------------------------------------
	{
	...
	{
		// --------------------------------------------------------------------------
		state* initial( CCounter_transincrFSM&sc ) {
		// --------------------------------------------------------------------------
	...
	{
		// --------------------------------------------------------------------------
		inline virtual state* unconditional( CCounter_transincrFSM &sc ) {
		// --------------------------------------------------------------------------
			int& value = sc.model.value;
			if ( value++ < 3 ) return transition<1, &state::unconditional, state_init, state_init>()( this, sc.m_state_init, sc );
			if ( true ) return transition<2, &state::unconditional, state_init, state_F>()( this, sc.m_state_F, sc );
			else return 0;
		}
	} m_state_init;
...
public:
	/* state handlers */
	virtual void stateInitEnter( CCounter_transincrFSM::data_model &m ) = 0;
	virtual void stateInitExit( CCounter_transincrFSM::data_model &m ) = 0;
	virtual void stateFEnter( CCounter_transincrFSM::data_model &m ) = 0;
	virtual void stateFExit( CCounter_transincrFSM::data_model &m ) = 0;

	/* transition handlers */

protected:
	virtual ~ICounter_transincrActionHandler( void ) { /* nop */ }
};

class CCounter_transincrActionHandlerDefault: public ICounter_transincrActionHandler
{
public:
	/* state handlers */
	virtual void stateInitEnter( CCounter_transincrFSM::data_model &m ) { /* default */ }
	virtual void stateInitExit( CCounter_transincrFSM::data_model &m ) { /* default */ }
	virtual void stateFEnter( CCounter_transincrFSM::data_model &m ) { /* default */ }
	virtual void stateFExit( CCounter_transincrFSM::data_model &m ) { /* default */ }

	/* transition handlers */

protected:
	virtual ~CCounter_transincrActionHandlerDefault( void ) { /* nop */ }
};


// --------------------------------------------------------------------------
template<> inline void CCounter_transincrFSM::state_actions<CCounter_transincrFSM::state_init>::enter( CCounter_transincrFSM::data_model &m )
// --------------------------------------------------------------------------
{
...
// --------------------------------------------------------------------------
template<> inline void CCounter_transincrFSM::state_actions<CCounter_transincrFSM::state_init>::exit( CCounter_transincrFSM::data_model &m )
// --------------------------------------------------------------------------
{
...
// --------------------------------------------------------------------------
template<> inline void CCounter_transincrFSM::state_actions<CCounter_transincrFSM::state_F>::enter( CCounter_transincrFSM::data_model &m )
// --------------------------------------------------------------------------
{
...
// --------------------------------------------------------------------------
template<> inline void CCounter_transincrFSM::state_actions<CCounter_transincrFSM::state_F>::exit( CCounter_transincrFSM::data_model &m )
// --------------------------------------------------------------------------
{
...
/* ************************************************************************ */
#endif // AUTOFSM_COUNTER_TRANSINCR_HPP
