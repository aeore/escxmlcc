...
public:
	...
	{
	public:
		virtual state* event_q( CCluster_multinodes_4FSM& ) { return 0; }
		virtual state* event_r( CCluster_multinodes_4FSM& ) { return 0; }
		virtual state* event_w( CCluster_multinodes_4FSM& ) { return 0; }
		virtual state* event_yy( CCluster_multinodes_4FSM& ) { return 0; }
...
public:
	...
	// --------------------------------------------------------------------------
	CCluster_multinodes_4FSM( ICluster_multinodes_4ActionHandler* pActionHandler ) : cur_state( &m_scxml )
	// --------------------------------------------------------------------------
	{
	...
	{
		state* initial( CCluster_multinodes_4FSM&sc ) { return transition<0, &state::initial, scxml, state_init, internal>()( this, sc.m_state_init, sc ); }
	} m_scxml;

	class state_init: public composite<state_init, scxml>
	{
		state* event_q( CCluster_multinodes_4FSM &sc ) {
	...
	{
		virtual state* unconditional( CCluster_multinodes_4FSM &sc ) {
	...
	class state_Cluster: public composite<state_Cluster, scxml>
	{
		...
		state* event_yy( CCluster_multinodes_4FSM &sc ) {
	...
	{
		state* event_r( CCluster_multinodes_4FSM &sc ) {
	...
	{
		state* event_w( CCluster_multinodes_4FSM &sc ) {
