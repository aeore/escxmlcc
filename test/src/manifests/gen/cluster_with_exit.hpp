#ifndef AUTOFSM_CLUSTER_WITH_EXIT_HPP
#define AUTOFSM_CLUSTER_WITH_EXIT_HPP
...
class ICluster_with_exitActionHandler;
class CCluster_with_exitFSM
{
public:
	struct data_model {
		friend class CCluster_with_exitFSM;
		data_model( void ) { /* nop */ }
	private:
		ICluster_with_exitActionHandler* actionHandler;
	} model;
...
public:
	...
	{
	public:
		state* operator()( S *s, D &d, CCluster_with_exitFSM &sc )
		{
	...
	{
	public:
		S* operator()( S *s, CCluster_with_exitFSM &sc )
		{
...
public:
	/* state handlers */
	virtual void stateInitEnter( CCluster_with_exitFSM::data_model &m ) = 0;
	virtual void stateInitExit( CCluster_with_exitFSM::data_model &m ) = 0;
	virtual void stateClusterEnter( CCluster_with_exitFSM::data_model &m ) = 0;
	virtual void stateClusterExit( CCluster_with_exitFSM::data_model &m ) = 0;
	virtual void stateAEnter( CCluster_with_exitFSM::data_model &m ) = 0;
	virtual void stateAExit( CCluster_with_exitFSM::data_model &m ) = 0;
	virtual void stateBEnter( CCluster_with_exitFSM::data_model &m ) = 0;
	virtual void stateBExit( CCluster_with_exitFSM::data_model &m ) = 0;
	virtual void stateCEnter( CCluster_with_exitFSM::data_model &m ) = 0;
	virtual void stateCExit( CCluster_with_exitFSM::data_model &m ) = 0;

	/* transition handlers */

protected:
	virtual ~ICluster_with_exitActionHandler( void ) { /* nop */ }
};

class CCluster_with_exitActionHandlerDefault: public ICluster_with_exitActionHandler
{
public:
	/* state handlers */
	virtual void stateInitEnter( CCluster_with_exitFSM::data_model &m ) { /* default */ }
	virtual void stateInitExit( CCluster_with_exitFSM::data_model &m ) { /* default */ }
	virtual void stateClusterEnter( CCluster_with_exitFSM::data_model &m ) { /* default */ }
	virtual void stateClusterExit( CCluster_with_exitFSM::data_model &m ) { /* default */ }
	virtual void stateAEnter( CCluster_with_exitFSM::data_model &m ) { /* default */ }
	virtual void stateAExit( CCluster_with_exitFSM::data_model &m ) { /* default */ }
	virtual void stateBEnter( CCluster_with_exitFSM::data_model &m ) { /* default */ }
	virtual void stateBExit( CCluster_with_exitFSM::data_model &m ) { /* default */ }
	virtual void stateCEnter( CCluster_with_exitFSM::data_model &m ) { /* default */ }
	virtual void stateCExit( CCluster_with_exitFSM::data_model &m ) { /* default */ }

	/* transition handlers */

protected:
	virtual ~CCluster_with_exitActionHandlerDefault( void ) { /* nop */ }
};


// --------------------------------------------------------------------------
template<> inline void CCluster_with_exitFSM::state_actions<CCluster_with_exitFSM::state_init>::enter( CCluster_with_exitFSM::data_model &m )
// --------------------------------------------------------------------------
{
...
// --------------------------------------------------------------------------
template<> inline void CCluster_with_exitFSM::state_actions<CCluster_with_exitFSM::state_init>::exit( CCluster_with_exitFSM::data_model &m )
// --------------------------------------------------------------------------
{
...
// --------------------------------------------------------------------------
template<> inline void CCluster_with_exitFSM::state_actions<CCluster_with_exitFSM::state_Cluster>::enter( CCluster_with_exitFSM::data_model &m )
// --------------------------------------------------------------------------
{
...
// --------------------------------------------------------------------------
template<> inline void CCluster_with_exitFSM::state_actions<CCluster_with_exitFSM::state_Cluster>::exit( CCluster_with_exitFSM::data_model &m )
// --------------------------------------------------------------------------
{
...
// --------------------------------------------------------------------------
template<> inline void CCluster_with_exitFSM::state_actions<CCluster_with_exitFSM::state_A>::enter( CCluster_with_exitFSM::data_model &m )
// --------------------------------------------------------------------------
{
...
// --------------------------------------------------------------------------
template<> inline void CCluster_with_exitFSM::state_actions<CCluster_with_exitFSM::state_A>::exit( CCluster_with_exitFSM::data_model &m )
// --------------------------------------------------------------------------
{
...
// --------------------------------------------------------------------------
template<> inline void CCluster_with_exitFSM::state_actions<CCluster_with_exitFSM::state_B>::enter( CCluster_with_exitFSM::data_model &m )
// --------------------------------------------------------------------------
{
...
// --------------------------------------------------------------------------
template<> inline void CCluster_with_exitFSM::state_actions<CCluster_with_exitFSM::state_B>::exit( CCluster_with_exitFSM::data_model &m )
// --------------------------------------------------------------------------
{
...
// --------------------------------------------------------------------------
template<> inline void CCluster_with_exitFSM::state_actions<CCluster_with_exitFSM::state_C>::enter( CCluster_with_exitFSM::data_model &m )
// --------------------------------------------------------------------------
{
...
// --------------------------------------------------------------------------
template<> inline void CCluster_with_exitFSM::state_actions<CCluster_with_exitFSM::state_C>::exit( CCluster_with_exitFSM::data_model &m )
// --------------------------------------------------------------------------
{
...
/* ************************************************************************ */
#endif // AUTOFSM_CLUSTER_WITH_EXIT_HPP
