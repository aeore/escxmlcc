#ifndef AUTOFSM_CLUSTER_TWONODES_HPP
#define AUTOFSM_CLUSTER_TWONODES_HPP
...
class ICluster_twonodesActionHandler;
class CCluster_twonodesFSM
{
public:
	struct data_model {
		friend class CCluster_twonodesFSM;
		data_model( void ) { /* nop */ }
	private:
		ICluster_twonodesActionHandler* actionHandler;
	} model;
...
public:
	...
	{
	public:
		virtual state* unconditional( CCluster_twonodesFSM& ) { return 0; }
		virtual state* unconditional_async( CCluster_twonodesFSM& ) { return 0; }
		virtual state* initial( CCluster_twonodesFSM& ) { return 0; }
	...
	state *cur_state;
	typedef state* ( state::*event )( CCluster_twonodesFSM& );
...
private: 
	...
	public:
		// --------------------------------------------------------------------------
		CPAsyncEventTransitionData( CCluster_twonodesFSM& fsm, const event trigger ): mFSM( fsm ), mTrigger( trigger ) { /* none */ }
		// --------------------------------------------------------------------------
	...
	public:
		// --------------------------------------------------------------------------
		CPAsyncTriggerInvoker( CCluster_twonodesFSM& fsm ) : mFsm( fsm ) { /* none */ }
		// --------------------------------------------------------------------------
...
public:
	...
	{
	public:
		state* operator()( S *s, D &d, CCluster_twonodesFSM &sc )
		{
	...
	{
	public:
		S* operator()( S *s, CCluster_twonodesFSM &sc )
		{
...
public:
	...
	// --------------------------------------------------------------------------
	CCluster_twonodesFSM( ICluster_twonodesActionHandler* pActionHandler ) : cur_state( &m_scxml ), asyncTriggerInvoker( *this )
	// --------------------------------------------------------------------------
	{
	...
	{
		// --------------------------------------------------------------------------
		state* initial( CCluster_twonodesFSM&sc ) {
		// --------------------------------------------------------------------------
	...
	{
		// --------------------------------------------------------------------------
		inline virtual state* unconditional( CCluster_twonodesFSM &sc ) {
		// --------------------------------------------------------------------------
	...
	{
		state* initial( CCluster_twonodesFSM &sc ) { return transition<0, &state::initial, state_Cluster, state_A, internal>()( this, sc.m_state_A, sc ); }
	} m_state_Cluster;
	...
	class state_A: public composite<state_A, state_Cluster>
	{
		...
		inline virtual state* unconditional( CCluster_twonodesFSM &sc ) {
		// --------------------------------------------------------------------------
			if ( true ) return transition<2, &state::unconditional, state_A, state_B>()( this, sc.m_state_B, sc );
			else return 0;
		}
	} m_state_A;
...
public:
	/* state handlers */
	virtual void stateInitEnter( CCluster_twonodesFSM::data_model &m ) = 0;
	virtual void stateInitExit( CCluster_twonodesFSM::data_model &m ) = 0;
	virtual void stateClusterEnter( CCluster_twonodesFSM::data_model &m ) = 0;
	virtual void stateClusterExit( CCluster_twonodesFSM::data_model &m ) = 0;
	virtual void stateAEnter( CCluster_twonodesFSM::data_model &m ) = 0;
	virtual void stateAExit( CCluster_twonodesFSM::data_model &m ) = 0;
	virtual void stateBEnter( CCluster_twonodesFSM::data_model &m ) = 0;
	virtual void stateBExit( CCluster_twonodesFSM::data_model &m ) = 0;

	/* transition handlers */

protected:
	virtual ~ICluster_twonodesActionHandler( void ) { /* nop */ }
};

class CCluster_twonodesActionHandlerDefault: public ICluster_twonodesActionHandler
{
public:
	/* state handlers */
	virtual void stateInitEnter( CCluster_twonodesFSM::data_model &m ) { /* default */ }
	virtual void stateInitExit( CCluster_twonodesFSM::data_model &m ) { /* default */ }
	virtual void stateClusterEnter( CCluster_twonodesFSM::data_model &m ) { /* default */ }
	virtual void stateClusterExit( CCluster_twonodesFSM::data_model &m ) { /* default */ }
	virtual void stateAEnter( CCluster_twonodesFSM::data_model &m ) { /* default */ }
	virtual void stateAExit( CCluster_twonodesFSM::data_model &m ) { /* default */ }
	virtual void stateBEnter( CCluster_twonodesFSM::data_model &m ) { /* default */ }
	virtual void stateBExit( CCluster_twonodesFSM::data_model &m ) { /* default */ }

	/* transition handlers */

protected:
	virtual ~CCluster_twonodesActionHandlerDefault( void ) { /* nop */ }
};


// --------------------------------------------------------------------------
template<> inline void CCluster_twonodesFSM::state_actions<CCluster_twonodesFSM::state_init>::enter( CCluster_twonodesFSM::data_model &m )
// --------------------------------------------------------------------------
{
...
// --------------------------------------------------------------------------
template<> inline void CCluster_twonodesFSM::state_actions<CCluster_twonodesFSM::state_init>::exit( CCluster_twonodesFSM::data_model &m )
// --------------------------------------------------------------------------
{
...
// --------------------------------------------------------------------------
template<> inline void CCluster_twonodesFSM::state_actions<CCluster_twonodesFSM::state_Cluster>::enter( CCluster_twonodesFSM::data_model &m )
// --------------------------------------------------------------------------
{
...
// --------------------------------------------------------------------------
template<> inline void CCluster_twonodesFSM::state_actions<CCluster_twonodesFSM::state_Cluster>::exit( CCluster_twonodesFSM::data_model &m )
// --------------------------------------------------------------------------
{
...
// --------------------------------------------------------------------------
template<> inline void CCluster_twonodesFSM::state_actions<CCluster_twonodesFSM::state_A>::enter( CCluster_twonodesFSM::data_model &m )
// --------------------------------------------------------------------------
{
...
// --------------------------------------------------------------------------
template<> inline void CCluster_twonodesFSM::state_actions<CCluster_twonodesFSM::state_A>::exit( CCluster_twonodesFSM::data_model &m )
// --------------------------------------------------------------------------
{
...
// --------------------------------------------------------------------------
template<> inline void CCluster_twonodesFSM::state_actions<CCluster_twonodesFSM::state_B>::enter( CCluster_twonodesFSM::data_model &m )
// --------------------------------------------------------------------------
{
...
// --------------------------------------------------------------------------
template<> inline void CCluster_twonodesFSM::state_actions<CCluster_twonodesFSM::state_B>::exit( CCluster_twonodesFSM::data_model &m )
// --------------------------------------------------------------------------
{
...
/* ************************************************************************ */
#endif // AUTOFSM_CLUSTER_TWONODES_HPP
