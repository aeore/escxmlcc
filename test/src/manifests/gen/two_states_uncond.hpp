#ifndef AUTOFSM_TWO_STATES_UNCOND_HPP
#define AUTOFSM_TWO_STATES_UNCOND_HPP
...
class ITwo_states_uncondActionHandler;
class CTwo_states_uncondFSM
{
public:
	struct data_model {
		friend class CTwo_states_uncondFSM;
		data_model( void ) { /* nop */ }
	private:
		ITwo_states_uncondActionHandler* actionHandler;
	} model;
...
public:
	...
	{
	public:
		virtual state* unconditional( CTwo_states_uncondFSM& ) { return 0; }
		virtual state* unconditional_async( CTwo_states_uncondFSM& ) { return 0; }
		virtual state* initial( CTwo_states_uncondFSM& ) { return 0; }
	...
	state *cur_state;
	typedef state* ( state::*event )( CTwo_states_uncondFSM& );
...
private: 
	...
	public:
		// --------------------------------------------------------------------------
		CPAsyncEventTransitionData( CTwo_states_uncondFSM& fsm, const event trigger ): mFSM( fsm ), mTrigger( trigger ) { /* none */ }
		// --------------------------------------------------------------------------
	...
	public:
		// --------------------------------------------------------------------------
		CPAsyncTriggerInvoker( CTwo_states_uncondFSM& fsm ) : mFsm( fsm ) { /* none */ }
		// --------------------------------------------------------------------------
...
public:
	...
	{
	public:
		state* operator()( S *s, D &d, CTwo_states_uncondFSM &sc )
		{
	...
	{
	public:
		S* operator()( S *s, CTwo_states_uncondFSM &sc )
		{
...
public:
	...
	// --------------------------------------------------------------------------
	CTwo_states_uncondFSM( ITwo_states_uncondActionHandler* pActionHandler ) : cur_state( &m_scxml ), asyncTriggerInvoker( *this )
	// --------------------------------------------------------------------------
	{
	...
	{
		// --------------------------------------------------------------------------
		state* initial( CTwo_states_uncondFSM&sc ) {
		// --------------------------------------------------------------------------
	...
	{
		// --------------------------------------------------------------------------
		inline virtual state* unconditional( CTwo_states_uncondFSM &sc ) {
		// --------------------------------------------------------------------------
...
public:
	/* state handlers */
	virtual void stateInitEnter( CTwo_states_uncondFSM::data_model &m ) = 0;
	virtual void stateInitExit( CTwo_states_uncondFSM::data_model &m ) = 0;
	virtual void stateNodeEnter( CTwo_states_uncondFSM::data_model &m ) = 0;
	virtual void stateNodeExit( CTwo_states_uncondFSM::data_model &m ) = 0;

	/* transition handlers */

protected:
	virtual ~ITwo_states_uncondActionHandler( void ) { /* nop */ }
};

class CTwo_states_uncondActionHandlerDefault: public ITwo_states_uncondActionHandler
{
public:
	/* state handlers */
	virtual void stateInitEnter( CTwo_states_uncondFSM::data_model &m ) { /* default */ }
	virtual void stateInitExit( CTwo_states_uncondFSM::data_model &m ) { /* default */ }
	virtual void stateNodeEnter( CTwo_states_uncondFSM::data_model &m ) { /* default */ }
	virtual void stateNodeExit( CTwo_states_uncondFSM::data_model &m ) { /* default */ }

	/* transition handlers */

protected:
	virtual ~CTwo_states_uncondActionHandlerDefault( void ) { /* nop */ }
};


// --------------------------------------------------------------------------
template<> inline void CTwo_states_uncondFSM::state_actions<CTwo_states_uncondFSM::state_init>::enter( CTwo_states_uncondFSM::data_model &m )
// --------------------------------------------------------------------------
{
...
// --------------------------------------------------------------------------
template<> inline void CTwo_states_uncondFSM::state_actions<CTwo_states_uncondFSM::state_init>::exit( CTwo_states_uncondFSM::data_model &m )
// --------------------------------------------------------------------------
{
...
// --------------------------------------------------------------------------
template<> inline void CTwo_states_uncondFSM::state_actions<CTwo_states_uncondFSM::state_Node>::enter( CTwo_states_uncondFSM::data_model &m )
// --------------------------------------------------------------------------
{
...
// --------------------------------------------------------------------------
template<> inline void CTwo_states_uncondFSM::state_actions<CTwo_states_uncondFSM::state_Node>::exit( CTwo_states_uncondFSM::data_model &m )
// --------------------------------------------------------------------------
{
...
/* ************************************************************************ */
#endif // AUTOFSM_TWO_STATES_UNCOND_HPP
